...
from app.routers import answer, answer_star, auth, basic_auth, grade, pages, quiz, learning_progress
...
app.include_router(learning_progress.router, prefix="/api/v1", tags=["learning-progress"])
