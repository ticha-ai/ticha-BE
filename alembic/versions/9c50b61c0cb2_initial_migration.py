...
def upgrade() -> None:
    ...
    sa.Column('difficulty', sa.Enum('easy', 'medium', 'hard', 'random'), nullable=False),
    sa.Column('total_problems_count', sa.Enum('5', '10', '20', '30'), nullable=False),
    sa.Column('status', sa.Enum('in_progress', 'graded', 'reviewed'), nullable=False),
    sa.Column('chapter_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True),
    sa.Column('deleted_at', sa.TIMESTAMP(), nullable=True),
    ...
    op.create_table('problems_in_quizzes',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('quiz_id', sa.Integer(), nullable=False),
    ...
    op.create_table('user_problems_stat',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('problem_id', sa.Integer(), nullable=False),
